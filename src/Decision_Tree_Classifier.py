...
# LEARNLIFT - STUDENT DROPOUT PREDICTION USING RAW DATASET
# ================================================================
#
# IMPORTANT:
...
# ================================================================
# 4. OUTPUT MAIN FOLDER
# ================================================================

OUTPUT_FOLDER = os.path.join(
    PROJECT_DIR,
    "Dataset",
    "Decision_Tree_Classifier_M3_Outputs"
)
...
# ================================================================
# 6. CREATE FOLDERS ONLY IF THEY DO NOT EXIST
# ================================================================
...
print(
    "             DECISION TREE - LEARNLIFT DROPOUT PREDICTION"
)
...
# ================================================================
# 14. REMOVE MISSING TARGET VALUES
# ================================================================
...
tree_classifier = model.named_steps[
    "classifier"
]
...
plt.title(
    "Decision Tree - Dropout Confusion Matrix"
)
...
plt.title(
    "Decision Tree Performance - LearnLift"
)
...
plt.title(
    "Actual vs Predicted Student Dropout"
)
...
plt.title(
    "Student Dropout Class Distribution"
)
...
# ================================================================
# 38. GET FEATURE NAMES AFTER ENCODING
# ================================================================
...
# ================================================================
# 40. SAVE FEATURE IMPORTANCE CSV
# ================================================================
...
plt.title(
    "Top 15 Decision Tree Feature Importances - LearnLift"
)
...
# ================================================================
# 42. DECISION TREE VISUALIZATION
# ================================================================
...
# ================================================================
# 47. SAVE DECISION TREE PARAMETERS
# ================================================================
...
print(
    "       LEARNLIFT DECISION TREE COMPLETED SUCCESSFULLY"
)
