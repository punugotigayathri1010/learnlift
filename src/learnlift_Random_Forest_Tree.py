...
OUTPUT_FOLDER = os.path.join(
    PROJECT_DIR,
    "outputs",
    "Random_Forest_Classifier_Outputs"
)
...
print(
    "             RANDOM FOREST - LEARNLIFT DROPOUT PREDICTION"
)
...
plt.title(
    ...
    "Random Forest - Dropout Confusion Matrix"
...
plt.title(
    ...
    "Random Forest Performance - LearnLift"
...
print(
    "          LEARNLIFT RANDOM FOREST COMPLETED SUCCESSFULLY"
)
