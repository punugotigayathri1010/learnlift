...
print("\n")
print("=" * 80)
print("              ADABOOST STUDENT DROPOUT PREDICTION")
print("=" * 80)
...
plt.title(
    "Actual vs Predicted Student Dropout - AdaBoost"
)
...
parameters_df = pd.DataFrame({
    ...
    "Parameter": [
        ...
        "Base Tree Min Samples Split",
        "Base Tree Min Samples Leaf",
        "Random State"
    ],
